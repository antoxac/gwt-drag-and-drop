 ...
 * 
 * If you run the tests using the Maven command line, you will have to navigate with your browser to
 * a specific url given by Maven. See
 * https://gwt-maven-plugin.github.io/gwt-maven-plugin/user-guide/testing.html for details.
 */
public class GwtTestDrag extends GWTTestCase {
